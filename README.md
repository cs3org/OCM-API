...
The Open Cloud Mesh API specification is an open source, community-driven project. The project is actively working on forming a [IETF Working Group](https://www.ietf.org/process/wgs/), please join our [IETF Mailing List](https://mailman3.ietf.org/mailman3/lists/ocm.ietf.org/) if you are interested.
